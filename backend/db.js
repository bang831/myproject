...
// Tambah tabel baru untuk health check dan notifikasi
db.exec(`
  ...
  CREATE INDEX IF NOT EXISTS idx_uptime_project ON uptime_logs(project_id);

  -- Tambah kolom health_failures ke projects kalau belum ada
